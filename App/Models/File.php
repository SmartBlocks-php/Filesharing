...
class File extends \Model
{
    ...
    /**
     * @ManyToOne(targetEntity="\Filesharing\File", inversedBy="subfiles")
     */
    private $parent_folder;

    /**
     * @OneToMany(targetEntity="\Filesharing\File", mappedBy="parent_folder")
     */
    private $subfiles;
    ...
    {
        $type = "unknown";
        if (file_exists(ROOT . DS . "Plugins" . DS . "Filesharing" . DS . "Data" . DS . "Files" . DS . $this->path))
        {
            if (!$this->is_folder)
            {
                $finfo = finfo_open(FILEINFO_MIME_TYPE);
                $type = finfo_file($finfo, ROOT . DS . "Plugins" . DS . "Filesharing" . DS . "Data" . DS . "Files" . DS . $this->path);
                finfo_close($finfo);
            }
            else
                $type = "folder";
