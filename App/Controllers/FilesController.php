...
//            var_dump($file->getSubfiles()->toArray());
    ...
    public function create()
    {
        ...
        if ($file->getName() != "")
        {
            ...
            if (isset($_FILES["file"]))
            {
                ...
                $path = ROOT . DS . "Plugins" . DS . "Filesharing" . DS . "Data" . DS . "Files" . DS;
    ...
    public function destroy($params = array())
    {
        ...
        if (is_object($file))
        {
            ...
            if (file_exists(ROOT . DS . "Plugins" . DS . "Filesharing" . DS . "Data" . DS . "Files" . DS . $file->getPath()))
            {
                unlink(ROOT . DS . "Plugins" . DS . "Filesharing" . DS . "Data" . DS . "Files" . DS . $file->getPath());
            }
    ...
    public function get_file($params = array())
    {
        ...
        if (is_object($file))
        {
            ...
            echo file_get_contents(ROOT . DS . "Plugins" . DS . "Filesharing" . DS . "Data" . DS . "Files" . DS . $file->getPath());
        }
    }
