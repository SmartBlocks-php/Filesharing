define([
    ...
    var FileUploadView = Backbone.View.extend({
        ...
        render: function () {
            ...
            var template = _.template(FileUploadTemplate, { parent_folder_id: base.folder_browser.folder ? base.folder_browser.folder.get("id") : null  });
        ...
        initializeEvents: function () {
            ...
            base.$el.find(".k_fs_upload_button").click(function () {
                ...
                base.$el.find("iframe").load(function (test) {

                    var file = new SmartBlocks.Blocks.Filesharing.Models.File($(test.target).contents().html());
                    console.log($(test.target).contents().html(), file);
