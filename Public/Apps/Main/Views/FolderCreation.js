define([
    ...
    'underscore',
    'backbone',
    'text!../Templates/folder_creation.html'
], function ($, _, Backbone, FolderCreationTemplate) {
    var FolderCreationView = Backbone.View.extend({
        ...
        initializeEvents: function () {
            ...
            base.$el.find(".k_fs_folder_creation_button").click(function () {
                ...
                folder.set("parent_folder", new SmartBlocks.Blocks.Filesharing.Models.File({ id: base.folder_browser.current_folder}) );
                console.log(folder);
